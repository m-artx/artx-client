...
export default function Layout() {
  return (
    <div className="flex flex-col h-screen    border-box font-sans border-blue-500 bg-black text-white max-w-[1300px] border">
      <div className="flex justify-center h-[140px] border">
        <Header />
      </div>
      <div
        className="flex-1 justify-center border border-blue-500
