...
function ProductList() {
    ...
    if (productCategoryType === 'PAINT') {
        apiUrl = `/api/products?category=PAINT&type=USER&page=0&size=1`;
    } else if (productCategoryType === 'CERAMIC') {
        apiUrl = `/api/products?category=CERAMIC&type=USER&page=0&size=1`;
    } else if (productCategoryType === 'ETC') {
        apiUrl = `/api/products?category=ETC&type=USER&page=0&size=1`;
