...
function MainPage() {
  ...
  return (
    <div className="flex flex-col items-center border border max-w-[1500px]">
      <input
      ...
      <div className="border border-red-800 grid grid-rows-2 min-h-screen h-full min-h-screen">
        {/* 첫번째 이미지칸 */}
