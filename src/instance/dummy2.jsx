...
export default function Dummy2() {
  const slides = [
    {
      productImageUrl: 'http://dafenart.co.kr/mall/shop_image/201702/20%2811%29.jpg',
    },
    {
      productImageUrl: 'https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2670&q=80',
    },
    {
    ...
    return slides; // 이미지 데이터 배열을 반환합니다.
